...
double summ[MAX_SIZE], *num, summ1;
...
/*    leaving transients*/               
    ...
    //       z[k] = y[j][1];   zz[k] = y[j-1][1]; 
      ...
      //  diff = fabs(y[1][1]) - fabs(y[j-1][1]);      
        
        
/*        fprintf(fp1,"%f \t",t);*/
/*            for(i=1;i<=nn;i++)*/
/*             fprintf(fp1,"%f   %f\t",y[i][1]);*/
/*           fprintf(fp1," \n"); */
